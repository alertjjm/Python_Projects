...
if Outcount[o] == "무사":
    out = tk.PhotoImage(file="C:\\Users\windows10\PycharmProjects\\untitled2\\0.png")
    labelout = tk.Label(window, image=out)
    labelout.pack()
elif Outcount[o] == "1사":
    out = tk.PhotoImage(file="C:\\Users\windows10\PycharmProjects\\untitled2\\11.png")
    labelout = tk.Label(window, image=out)
    labelout.pack()
elif Outcount[o] == "2사":
    out = tk.PhotoImage(file="C:\\Users\windows10\PycharmProjects\\untitled2\\2.png")
    labelout = tk.Label(window, image=out)
    labelout.pack()
description2.pack()
