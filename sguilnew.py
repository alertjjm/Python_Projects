...
fd.write("count,event,main_id,datetime,EventMessage,src_ip,dst_ip,ipver,hlen,tos,dlen,id,flags,offset,ttl,chksum,protocol,src_port,dst_port,protocol,dummy,seq,ack,off,res,flags,win")
fd.writelines(data)
fd.close()
